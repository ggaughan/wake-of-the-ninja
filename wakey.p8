	...
	if pl.x < 0.5 or pl.x > 15.5 then
	 if pl.room == nil then
		 ...
		 -- note: +1 for extra row for upward scroll
			...
			local scroll_y 
			if in_water then
				scroll_y = (14.4-pl.y)  -- extra 0.1 for collision smoothout
			else
		 	...
		 	for i=0,rnd(3)+1 do
			  ...
			  need = false
				...
				if #rooms > 0 and y-last_ledge > 1 then
 				if (rnd() > 0.80 and y > room_range_start and y < room_range_end) or need_room then
		 ...
		 if need or rnd() > 0.5 then
		  if w[y] == nil then
 		  ...
 		  need = false
				...
				if #rooms > 0 and y-last_ledge > 1 then
	  		if rnd() > 0.80 and y > room_range_start and y < room_range_end then
						local room = rooms[#rooms]
						rooms[#rooms]=nil
						link_room(room, y, r)
					end
...
function make_world(h)
	...
	-- extra rooms harcoded in map from x=16 (2 16x16 room levels deep)
	...
	-- todo place highest/lowest rooms manually here

	-- note last_ledge==0 -> need_room
 make_world_row(water_level+3)  -- above start pipe
	...
	-- inidicator for durer room
	if (w[water_level+3] == nil) w[water_level+3+1] = {}
 w[water_level+3][0] = 126

	if #rooms > 0 then
		-- todo place any leftover rooms manually here
...
__gff__

...
__map__

__sfx__
